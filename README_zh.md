...
### 💡 为什么选择 Cebian？（全能竞品横向对比）

苦于非三星手机无法使用 **One Hand Operation+ (OHO+)**？想要一个完全开源、无隐私顾虑、现代审美的 **FooView**？或是渴望无需付费买断的 **Quick Cursor** 单手指针？Cebian 专为解决这些痛点而生：

| 功能与特性 | **Cebian (边栏)** | **Samsung OHO+** | **Quick Cursor** | **FooView (FV悬浮球)** |
| :--- | :---: | :---: | :---: | :---: |
| **开源协议与隐私** | **AGPL-3.0 (完全开源自由)** | ❌ 闭源商业 | ❌ 闭源商业 | ❌ 闭源商业 |
| **机型与品牌兼容** | **所有 Android 12+ 手机** | ❌ 仅限三星 Galaxy 独占 | ✅ 全机型 | ✅ 全机型 |
| **资费与广告策略** | **永久免费 / 无广告 / 零内购** | ✅ 免费 (绑三星设备) | ❌ 高级版需内购买断 | ⚠️ 包含商业广告 |
| **边缘手势 (多段多角度)** | ✅ 完美复刻 OHO+ 直线/斜角/长滑 | ✅ 原生 | ❌ 无 | ⚠️ 仅悬浮球手势 |
| **单手大屏指针触达** | ✅ 内置浮动光标与摇杆触达 | ❌ 无 | ✅ 原生 | ❌ 无 |
| **悬浮球 OCR 识图与分词** | ✅ 本地离线引擎 (PaddleOCR/MLKit/Jieba) | ❌ 无 | ❌ 无 | ⚠️ 依赖云端接口 |
| **以图搜图聚合检索** | ✅ 聚合 10+ 顶级搜图引擎 (支持 SearchEVO 导入) | ❌ 无 | ❌ 无 | ⚠️ 规则较少 |
| **系统级深度提权** | ✅ Shizuku + Root + LSPosed + 无障碍 | ❌ 无 | ⚠️ 仅无障碍 | ⚠️ 仅无障碍 |
| **现代化动效设计** | ✅ Miuix 流体阻尼与高斯模糊 | ⚠️ 仅 One UI | ⚠️ 普通 Material | ⚠️ 经典老旧界面 |
