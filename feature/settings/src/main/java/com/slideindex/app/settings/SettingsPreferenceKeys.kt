...
internal object SettingsPreferenceKeys {
    ...
    val SYSTEM_GESTURE_TAKEOVER_TOP = booleanPreferencesKey("system_gesture_takeover_top")
    val SYSTEM_GESTURE_TAKEOVER_SIDES = booleanPreferencesKey("system_gesture_takeover_sides")
    val SYSTEM_GESTURE_TAKEOVER_BOTTOM = booleanPreferencesKey("system_gesture_takeover_bottom")
    ...
    val HAPTIC_GESTURE_TRIGGER_ENABLED = booleanPreferencesKey("haptic_gesture_trigger_enabled")
    val HAPTIC_SLOT_SELECTION_ENABLED = booleanPreferencesKey("haptic_slot_selection_enabled")
    val HAPTIC_CONFIRM_LAUNCH_ENABLED = booleanPreferencesKey("haptic_confirm_launch_enabled")
    ...
    val APP_CAROUSEL_CANCEL_DISTANCE_DP = intPreferencesKey("app_carousel_cancel_distance_dp")
    val APP_CAROUSEL_SEPARATE_CANCEL_DISTANCES = booleanPreferencesKey("app_carousel_separate_cancel_distances")
    ...
    val HOLOGRAPHIC_BACKGROUND_STYLE = intPreferencesKey("holographic_background_style")
    val HOLOGRAPHIC_BLUR_DP = intPreferencesKey("holographic_blur_dp")
    ...
    val KEYBOARD_TRIGGER_NARROW_PERCENT_LANDSCAPE = intPreferencesKey("keyboard_trigger_narrow_percent_landscape")
    ...
    val FINGERTIP_RING_SLOT_COUNT = intPreferencesKey("fingertip_ring_slot_count")
    val FINGERTIP_RING_ORBIT_RADIUS_PX = floatPreferencesKey("fingertip_ring_orbit_radius_px")
    val FINGERTIP_RING_ICON_SIZE_PX = floatPreferencesKey("fingertip_ring_icon_size_px")
    val FINGERTIP_RING_VISUAL_STYLE = intPreferencesKey("fingertip_ring_visual_style")
    val FINGERTIP_RING_OUTER_SIZE = floatPreferencesKey("fingertip_ring_outer_size_px")
    val FINGERTIP_RING_INNER_SIZE = floatPreferencesKey("fingertip_ring_inner_size_px")
    val FINGERTIP_RING_OUTER_COLOR = intPreferencesKey("fingertip_ring_outer_color")
    val FINGERTIP_RING_INNER_COLOR = intPreferencesKey("fingertip_ring_inner_color")
    val FINGERTIP_RING_DIVIDER_SIZE = floatPreferencesKey("fingertip_ring_divider_size_px")
    val FINGERTIP_RING_DIVIDER_COLOR = intPreferencesKey("fingertip_ring_divider_color")
    val FINGERTIP_RING_ICON_SIZE = floatPreferencesKey("fingertip_ring_icon_size_fraction")
    val FINGERTIP_RING_ICON_COLOR = intPreferencesKey("fingertip_ring_icon_color")
    val FINGERTIP_RING_SLOTS = stringSetPreferencesKey("fingertip_ring_slots")
    ...
    val OTP_CODE_NOTIFICATION_ENABLED = booleanPreferencesKey("otp_code_notification_enabled")
    val OTP_CODE_NOTIFICATION_RETENTION_SECONDS = intPreferencesKey("otp_code_notification_retention_seconds")
    val OTP_SHOW_CODE_TOAST = booleanPreferencesKey("otp_show_code_toast")
    val OTP_SMS_BLACKLIST = stringPreferencesKey("otp_sms_blacklist")
    val OTP_BLOCK_CODE_SMS_ENABLED = booleanPreferencesKey("otp_block_code_sms_enabled")
    val OTP_MARK_SMS_READ_ENABLED = booleanPreferencesKey("otp_mark_sms_read_enabled")
    val OTP_DELETE_SMS_AFTER_EXTRACT_ENABLED = booleanPreferencesKey("otp_delete_sms_after_extract_enabled")
    val OTP_RECORD_CODE_ENABLED = booleanPreferencesKey("otp_record_code_enabled")
    val OTP_RECORD_PLAIN_SMS_ENABLED = booleanPreferencesKey("otp_record_plain_sms_enabled")
    val OTP_RECORD_APP_NOTIFY_ENABLED = booleanPreferencesKey("otp_record_app_notify_enabled")
    val OTP_RECORD_CODE_LIMIT = intPreferencesKey("otp_record_code_limit")
    val OTP_RECORD_PLAIN_SMS_LIMIT = intPreferencesKey("otp_record_plain_sms_limit")
    val OTP_RECORD_APP_NOTIFY_LIMIT = intPreferencesKey("otp_record_app_notify_limit")
    val OTP_BLOCKED_PACKAGES = stringSetPreferencesKey("otp_blocked_packages")
    ...
    val SHAKE_SENSITIVITY_V3_MIGRATED = booleanPreferencesKey("shake_sensitivity_v3_migrated")
    ...
    val BACK_TAP_MODE = intPreferencesKey("back_tap_mode")
    val BACK_TAP_PAUSE_CHARGING = booleanPreferencesKey("back_tap_pause_charging")
    val BACK_TAP_VIBRATION_FEEDBACK_ENABLED = booleanPreferencesKey("back_tap_vibration_feedback_enabled")
    val BACK_TAP_ACTION_TYPE = intPreferencesKey("back_tap_action_type")
    val BACK_TAP_ACTION_PAYLOAD = stringPreferencesKey("back_tap_action_payload")
    ...
    val MESSAGE_C_NOTICE_ENABLED = booleanPreferencesKey("message_c_notice_enabled")
    ...
    val MESSAGE_C_NOTICE_OPACITY = floatPreferencesKey("message_c_notice_opacity")
    val MESSAGE_C_NOTICE_DIMMED_OPACITY = floatPreferencesKey("message_c_notice_dimmed_opacity")
    val MESSAGE_C_NOTICE_GHOST_OPACITY = floatPreferencesKey("message_c_notice_ghost_opacity")
    ...
    val MESSAGE_C_NOTICE_ICON_SIZE_DP = floatPreferencesKey("message_c_notice_icon_size_dp")
    val MESSAGE_C_NOTICE_MAX_COUNT = intPreferencesKey("message_c_notice_max_count")
    ...
    val MESSAGE_C_NOTICE_AUTO_DISMISS_SECONDS =
        intPreferencesKey("message_c_notice_auto_dismiss_seconds")
    val MESSAGE_C_NOTICE_HORIZONTAL_EDGE = stringPreferencesKey("message_c_notice_horizontal_edge")
    val MESSAGE_C_NOTICE_Y_FRACTION = floatPreferencesKey("message_c_notice_y_fraction")
    val MESSAGE_C_NOTICE_EDGE_MARGIN_DP = floatPreferencesKey("message_c_notice_edge_margin_dp")
    val MESSAGE_C_NOTICE_DIM_DELAY_MS = intPreferencesKey("message_c_notice_dim_delay_ms")
    val MESSAGE_C_NOTICE_GHOST_DELAY_MS = intPreferencesKey("message_c_notice_ghost_delay_ms")
    val MESSAGE_C_NOTICE_DEFAULT_COLLAPSED = booleanPreferencesKey("message_c_notice_default_collapsed")
    val MESSAGE_C_NOTICE_PEEK_BANNER_ENABLED = booleanPreferencesKey("message_c_notice_peek_banner_enabled")
    val MESSAGE_C_NOTICE_LANDSCAPE_ENABLED = booleanPreferencesKey("message_c_notice_landscape_enabled")
    ...
    val MESSAGE_SIDE_Y_FRACTION = floatPreferencesKey("message_side_y_fraction")
    val MESSAGE_FLOAT_ICON_CORNER = stringPreferencesKey("message_float_icon_corner")
    val MESSAGE_FLOAT_ICON_Y_FRACTION = floatPreferencesKey("message_float_icon_y_fraction")
    ...
    val FLOAT_BALL_PICK_COPY_BUTTON_POSITION = stringPreferencesKey("float_ball_pick_copy_button_position")
    val FLOAT_BALL_PICK_IMAGE_TOOLBAR_POSITION = stringPreferencesKey("float_ball_pick_image_toolbar_position")
    ...
    val CLIPBOARD_FLOAT_ENTRY_CLICK_ACTION_SINGLE_LINE =
        stringPreferencesKey("clipboard_float_entry_click_action_single_line")
    val CLIPBOARD_FLOAT_ENTRY_CLICK_ACTION_CARD =
        stringPreferencesKey("clipboard_float_entry_click_action_card")
    val CLIPBOARD_FLOAT_ENTRY_LONG_PRESS_ACTION_SINGLE_LINE =
        stringPreferencesKey("clipboard_float_entry_long_press_action_single_line")
    val CLIPBOARD_FLOAT_ENTRY_LONG_PRESS_ACTION_CARD =
        stringPreferencesKey("clipboard_float_entry_long_press_action_card")
