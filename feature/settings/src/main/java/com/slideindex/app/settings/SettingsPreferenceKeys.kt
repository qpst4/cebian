...
internal object SettingsPreferenceKeys {
    ...
    val APP_SWITCHER_ITEMS = stringSetPreferencesKey("app_switcher_items")
    val APP_SWITCHER_ICON_SIZE_DP = intPreferencesKey("app_switcher_icon_size_dp")
    val APP_SWITCHER_SPACING_DP = intPreferencesKey("app_switcher_spacing_dp")
    val APP_SWITCHER_SELECTION_SCALE = intPreferencesKey("app_switcher_selection_scale")
    val APP_SWITCHER_PIN_ON_RELEASE = booleanPreferencesKey("app_switcher_pin_on_release")
    val APP_SWITCHER_EMPTY_TAP_CLOSE = booleanPreferencesKey("app_switcher_empty_tap_close")
    val APP_SWITCHER_SHOW_SELECTED_NAME = booleanPreferencesKey("app_switcher_show_selected_name")
    val APP_SWITCHER_SELECTED_HINT_ICON_SIZE_DP = intPreferencesKey("app_switcher_selected_hint_icon_size_dp")
    val APP_SWITCHER_DIM_PERCENT = intPreferencesKey("app_switcher_dim_percent")
    val APP_SWITCHER_BLUR_DP = intPreferencesKey("app_switcher_blur_dp")
    val APP_SWITCHER_SLOT_HAPTIC = booleanPreferencesKey("app_switcher_slot_haptic")
    val APP_SWITCHER_INITIAL_RADIUS_RATIO_PERCENT = intPreferencesKey("app_switcher_initial_radius_ratio_percent")
