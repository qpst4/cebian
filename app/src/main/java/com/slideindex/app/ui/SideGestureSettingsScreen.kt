...
fun SideGestureSettingsScreen(
    ...
    val shortDistanceItems = sideGestureSlotCardItems(
        ...
        triggers = GestureTriggerType.shortDistanceEntries(),
    ...
    val longDistanceItems = sideGestureSlotCardItems(
        ...
        triggers = GestureTriggerType.longDistanceEntries(),
    ...
    SettingsScreenScaffold(
        ...
        settingsLazySmallTitle(
            ...
            key = "section-short-distance",

            title = shortDistanceSectionTitle,

            sectionTop = true,

        )

        groupedCardItems("side-gesture-short", shortDistanceItems)
        ...
        settingsLazySmallTitle(
            ...
            key = "section-long-distance",

            title = longDistanceSectionTitle,

            sectionTop = true,

        )

        groupedCardItems("side-gesture-long", longDistanceItems)
